...
TransactionReport = function(args) {
  ...
  if (args) {
    ...
    if (args.sumResult !== undefined) {
      this.sumResult = args.sumResult;
    } else {
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field sumResult is unset!');
    }
  }
};
...
TransactionReport.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRUCT) {
        this.sumResult = new ReportResultValues();
        this.sumResult.read(input);
      } else {
        input.skip(ftype);
      }
      break;
...
TransactionReport.prototype.write = function(output) {
  ...
  if (this.results !== null && this.results !== undefined) {
    ...
    for (var iter217 in this.results)
    {
      if (this.results.hasOwnProperty(iter217))
      {
        iter217 = this.results[iter217];
  ...
  if (this.sumResult !== null && this.sumResult !== undefined) {
    output.writeFieldBegin('sumResult', Thrift.Type.STRUCT, 2);
    this.sumResult.write(output);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem224 = null;
          elem224 = new ReportMetric();
          elem224.read(input);
          this.metrics.push(elem224);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        this.dimensions = [];
        var _etype228 = 0;
        _rtmp3229 = input.readListBegin();
        _etype228 = _rtmp3229.etype;
        _size225 = _rtmp3229.size;
        for (var _i230 = 0; _i230 < _size225; ++_i230)
        {
          var elem231 = null;
          elem231 = new ReportDimension();
          elem231.read(input);
          this.dimensions.push(elem231);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem238 = null;
          elem238 = new ReportMetric();
          elem238.read(input);
          this.sortBys.push(elem238);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BehaviorReportRequest.prototype.write = function(output) {
  ...
  if (this.metrics !== null && this.metrics !== undefined) {
    output.writeFieldBegin('metrics', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRUCT, this.metrics.length);
    for (var iter239 in this.metrics)
    {
      if (this.metrics.hasOwnProperty(iter239))
      {
        iter239 = this.metrics[iter239];
  ...
  if (this.dimensions !== null && this.dimensions !== undefined) {
    output.writeFieldBegin('dimensions', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.dimensions.length);
    for (var iter240 in this.dimensions)
    {
      if (this.dimensions.hasOwnProperty(iter240))
      {
        iter240 = this.dimensions[iter240];
  ...
  if (this.sortBys !== null && this.sortBys !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.sortBys.length);
    for (var iter241 in this.sortBys)
    {
      if (this.sortBys.hasOwnProperty(iter241))
      {
        iter241 = this.sortBys[iter241];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem248 = null;
          elem248 = new ReportDimensionValue();
          elem248.read(input);
          this.dimensionValues.push(elem248);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BehaviorReportResult.prototype.write = function(output) {
  ...
  if (this.dimensionValues !== null && this.dimensionValues !== undefined) {
    output.writeFieldBegin('dimensionValues', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRUCT, this.dimensionValues.length);
    for (var iter249 in this.dimensionValues)
    {
      if (this.dimensionValues.hasOwnProperty(iter249))
      {
        iter249 = this.dimensionValues[iter249];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem256 = null;
          elem256 = new BehaviorReportResult();
          elem256.read(input);
          this.results.push(elem256);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BehaviorReport.prototype.write = function(output) {
  ...
  if (this.results !== null && this.results !== undefined) {
    output.writeFieldBegin('results', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRUCT, this.results.length);
    for (var iter257 in this.results)
    {
      if (this.results.hasOwnProperty(iter257))
      {
        iter257 = this.results[iter257];
